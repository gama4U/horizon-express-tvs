...
import { IUpdateTourItinerary, updateTourItinerary } from "../../../../api/mutations/itinerary.mutation";
import { IItinerary } from "../../../../interfaces/tour.interface";
import { useEffect } from "react";

interface EditTourItineraryProps {
...
export function EditTourItineraryDialog({ itinerary, openDialog, setOpenDialog }: EditTourItineraryProps) {
	...
	const { mutate: updateItineraryMutate, isPending: updatingItinerary } = useMutation({
		mutationFn: async (data: IUpdateTourItinerary) => await updateTourItinerary(data),
		onError: (error) => {
				...
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
						...
						<div className="flex justify-end">
							<Button type="submit" className="text-xs" disabled={updatingItinerary}>
								{
									updatingItinerary ?
